...
dependencies {
    ...
    implementation("com.x3mads.android.xmediator.mediation:google-ads:24.4.0.1")
    // hyprmx
    ...
    // tappx
    implementation("com.tappx.sdk.android:tappx-sdk:4.1.13")
    ...
    implementation("com.x3mads.android.xmediator.mediation:unity:4.15.1.0")
    // liftoff monetize
    implementation("com.vungle:vungle-ads:7.5.0")
    implementation("com.unity3d.ads-mediation:vungle-adapter:4.3.30")
    implementation("com.applovin.mediation:vungle-adapter:7.5.0.3")
