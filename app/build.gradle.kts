...
dependencies {
    ...
    implementation("com.x3mads.android.xmediator.mediation:fairbid:3.60.0.0")
    ...
    implementation("com.ironsource.adapters:mintegraladapter:4.3.40")
    ...
    implementation("com.google.ads.mediation:moloco:3.9.0.0")
