...
dependencies {
    ...
    // -- Mediation Libraries --
    implementation("com.x3mads.android.xmediator:core:1.145.1")
    implementation("com.x3mads.android.xmediator.mediation:applovin:13.5.1.6")
    implementation("com.x3mads.android.xmediator.mediation:google-ads:24.9.0.3")
    implementation("com.x3mads.android.xmediator.mediation:ironsource:9.3.0.1")
    ...
    implementation("com.unity3d.ads-mediation:bigo-adapter:5.4.0")
    ...
    implementation("com.applovin.mediation:fyber-adapter:8.4.3.0")
    implementation("com.x3mads.android.xmediator.mediation:fyber:8.4.3.0")
    // google ads
    implementation("com.google.android.gms:play-services-ads:24.9.0")
    implementation("com.unity3d.ads-mediation:admob-adapter:5.4.0")
    implementation("com.applovin.mediation:google-ad-manager-adapter:24.9.0.1")
    implementation("com.applovin.mediation:google-adapter:24.9.0.0")
    implementation("com.x3mads.android.xmediator.mediation:google-ads:24.9.0.3")
    // hyprmx
    implementation("com.hyprmx.android:HyprMX-SDK:6.4.5")
    implementation("com.hyprmx.android:HyprMX-AdMob:6.4.5.0")
    ...
    implementation("com.unity3d.ads-mediation:inmobi-adapter:5.1.0")
    ...
    implementation("com.applovin.mediation:ironsource-adapter:9.3.0.0.0")
    implementation("com.x3mads.android.xmediator.mediation:ironsource:9.3.0.1")
    // mintegral
    ...
    // mobilefuse
    implementation("com.mobilefuse.sdk:mobilefuse-sdk-core:1.10.0")
    implementation("com.mobilefuse.sdk:mobilefuse-adapter-admob:1.10.0.0")
    implementation("com.unity3d.ads-mediation:mobilefuse-adapter:5.1.0")
    implementation("com.applovin.mediation:mobilefuse-adapter:1.10.0.0")
    implementation("com.x3mads.android.xmediator.mediation:mobile-fuse:1.10.0.0")
    // moloco
    implementation("com.moloco.sdk.adapters:adapter:4.3.1")
    ...
    implementation("com.x3mads.android.xmediator.mediation:moloco:4.3.1.0")
    // ogury
    ...
    // pangle
    implementation("com.pangle.global:pag-sdk:7.8.6.0")
    implementation("com.google.ads.mediation:pangle:7.8.5.9.0")
    implementation("com.unity3d.ads-mediation:pangle-adapter:5.5.0")
    implementation("com.applovin.mediation:bytedance-adapter:7.8.6.0.0")
    implementation("com.x3mads.android.xmediator.mediation:pangle:7.8.5.9.0")
    // pubmatic
    implementation("com.pubmatic.sdk:openwrap:4.12.0")
    implementation("com.google.ads.mediation:pubmatic:4.12.0.0")
    implementation("com.applovin.mediation:pubmatic-adapter:4.12.0.0")
    // smaato
    ...
    implementation("com.unity3d.ads-mediation:bidmachine-adapter:5.2.0")
    implementation("com.applovin.mediation:bidmachine-adapter:3.5.1.0")
    implementation("com.x3mads.android.xmediator.mediation:stack:3.5.1.0")
    // tappx
    implementation("com.tappx.sdk.android:tappx-sdk:4.1.18")
    implementation("com.x3mads.android.xmediator.mediation:tappx:4.1.17.0")
    // unity ads
    ...
    implementation("com.x3mads.android.xmediator.mediation:unity:4.16.6.0")
    // verve
    ...
    implementation("com.x3mads.android.xmediator.mediation:vungle:7.7.0.0")
    // yandex
    implementation("com.yandex.android:mobileads:7.18.2")
    implementation("com.unity3d.ads-mediation:yandex-adapter:5.4.0")
    implementation("com.applovin.mediation:yandex-adapter:7.18.2.0")
    implementation("com.x3mads.android.xmediator.mediation:yandex:7.18.2.0")

    // -- Additional Tools --
    // UMP
    implementation("com.x3mads.android.xmediator.tools:ump:3.2.0.1")
