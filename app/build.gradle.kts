...
dependencies {
    ...
    // -- Mediation Libraries --
    implementation("com.x3mads.android.xmediator:core:1.117.0")
    ...
    implementation("com.x3mads.android.xmediator.mediation:ironsource:8.10.0.3")
    ...
    implementation("com.applovin.mediation:chartboost-adapter:9.9.2.0")
    ...
    implementation("com.mobilefuse.sdk:mobilefuse-adapter-admob:1.9.2.0")
    ...
    // moloco
    implementation("com.moloco.sdk.adapters:adapter:3.11.0")
    implementation("com.google.ads.mediation:moloco:3.11.0.0")
    implementation("com.unity3d.ads-mediation:moloco-adapter:4.3.19")
    implementation("com.applovin.mediation:moloco-adapter:3.11.0.1")
    implementation("com.x3mads.android.xmediator.mediation:moloco:3.11.0.0")
    // ogury
    ...
    // pangle
    implementation("com.pangle.global:pag-sdk:7.3.0.5")
    implementation("com.google.ads.mediation:pangle:7.3.0.5.0")
    implementation("com.unity3d.ads-mediation:pangle-adapter:4.3.48")
    implementation("com.applovin.mediation:bytedance-adapter:7.3.0.5.0")
    implementation("com.x3mads.android.xmediator.mediation:pangle:7.3.0.4.0")
    // bidmachine
    implementation("io.bidmachine:ads:3.3.0")
    implementation("com.unity3d.ads-mediation:bidmachine-adapter:4.3.15")
    implementation("com.applovin.mediation:bidmachine-adapter:3.3.0.2")
    implementation("com.x3mads.android.xmediator.mediation:stack:3.3.0.0")
    // tappx
    implementation("com.tappx.sdk.android:tappx-sdk:4.1.14")
    implementation("com.x3mads.android.xmediator.mediation:tappx:4.1.13.0")
    // unity ads
    implementation("com.unity3d.ads:unity-ads:4.16.0")
    implementation("com.google.ads.mediation:unity:4.16.0.0")
    implementation("com.unity3d.ads-mediation:unityads-adapter:4.3.58")
    implementation("com.applovin.mediation:unityads-adapter:4.16.0.0")
    implementation("com.x3mads.android.xmediator.mediation:unity:4.16.0.0")
    // liftoff monetize
